				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							...
							<div class="hero-btns">
								<a href="<?= base_url('shop') ?>" class="boxed-btn">Fruit Collection</a>
		...
		<div class="container">
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6">
					...
					<a href="<?= base_url('cart') ?>" class="cart-btn mt-3"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="shop-banner">
		<div class="container">
			...
			<a href="<?= base_url('shop') ?>" class="cart-btn btn-lg">Shop Now</a>
		</div>
	</section>
	<!-- end shop banner -->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<a href="<?= base_url('news') ?>" class="boxed-btn">More News</a>
				</div>
			</div>
		</div>
	</div>
