            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="full price_table padding_infor_info">
                        <form action="<?php echo base_url('accounts/add_blogs_video') ?>" method="post" name="blogForm" id="blogForm" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="label_field">Add Video Link</label>
                                    <input type="text" name="video" id="video" class="form-control <?php echo (form_error('video') != "") ? 'is-invalid' : ''; ?>" value="<?= set_value('video'); ?>" />
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control <?php echo (form_error('sub_category') != "") ? 'is-invalid' : ''; ?>">
                                        ...
                                        <?php foreach ($subCat as $subCateg) { ?>
                                            <option <?php echo set_select('sub_category', $subCateg->id, false); ?> value="<?= $subCateg->id; ?>"><?= $subCateg->sub_category; ?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="main_heading" id="main_heading" class="form-control <?php echo (form_error('main_heading') != "") ? 'is-invalid' : ''; ?>" value="<?= set_value('main_heading'); ?>" />
                                    <?php echo form_error('main_heading'); ?>
                                </div>
                                <div class="col-md-12 form-group">
                                    <label class="label_field">Description</label>
                                    <textarea name="description" id="description" class="form-control <?php echo (form_error('description') != "") ? 'is-invalid' : ''; ?>" rows="6"><?= set_value('description'); ?></textarea>
