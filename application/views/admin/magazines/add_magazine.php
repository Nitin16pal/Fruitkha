            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <div class="full price_table padding_infor_info">
                        <form action="<?php echo base_url('accounts/add_magazine') ?>" method="post" name="magazineForm" id="magazineForm" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-3">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="magazine_url" id="magazine_url" class="form-control <?php echo (form_error('magazine_url') != "") ? 'is-invalid' : ''; ?>" value="<?= set_value('magazine_url'); ?>" />
                                    <?php echo form_error('magazine_url'); ?>
                                </div>
                                <!-- <div class="col-md-6 form-group">
                                    <label class="label_field">Magazine</label>
                                    <input type="file" name="magazine_file" id="magazine_file" class="form-control <?php echo (!empty($pdfError)) ? 'is-invalid' : ''; ?>" style="padding: 0.19rem .2rem;" />
